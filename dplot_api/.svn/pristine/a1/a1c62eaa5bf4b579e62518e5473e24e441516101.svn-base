 ...
 */
@RestController
@RequestMapping("/admin/operation/magazine/banner")
public class MagazineBannerController extends ExcelDownController {
	@Autowired
	private MagazineBannerService magazineBannerService;
	...
	public Response bannerPage(@RequestBody SOMap params) throws Exception {
		return new Response(magazineBannerService.selectMainBannerList(params));
	}
	...
	public Response bannerUpdateUse(@RequestBody SOMap params) throws Exception {
		return new Response(magazineBannerService.updateMainBanner(params));
	}
	...
	public Response bannerModify(@RequestPart("params") SOMap params, MultipartHttpServletRequest fileParams) throws Exception {
		...
		return new Response(magazineBannerService.modifyBanner(params, uploadFile));
	}
	 ...
	 */
	 ...
	 public Response saveBanner(@RequestPart("params") SOMap params, MultipartHttpServletRequest fileParams) throws Exception{
		 Map<String, MultipartFile> uploadFile = fileParams.getFileMap();
		 return new Response(magazineBannerService.saveMainBanner(params, uploadFile));
	 }
	 ...
	 */
	 ...
	 {
		 return new Response(magazineBannerService.selectBannerDetail(params));
	 }
	...
	public Response bannerCheck(@RequestBody SOMap params) throws Exception {
		return new Response(magazineBannerService.checkBanner(params));
	}
}
