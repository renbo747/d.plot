...
public class AdminClaimController extends ExcelDownController{
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/proc/return/man", method = RequestMethod.POST)
    public Response procReturnMan(@RequestBody SOMap params) throws Exception {
    	SOMap result = adminClaimService.procReturnMan(params);
    	return new Response(result);
    }
