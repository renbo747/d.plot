<template>
  <div id="modal-wrap" class="modal" style="display: block;">
    <div class="modal-content" style="width: 480px;">
      ...
      <div class="pop-body">
        <div class="title">휴대폰으로 인증문자가 발송됩니다.</div>
...
export default {
  ...
  methods : {
    userAuthCheck: function(){
      ...
      this.certPopupObj = window.open('/common/partnership/kmc/request?code='+process.env.VUE_APP_KMC_CERT_ADMIN+"&name="+this.info.name+"&phone="+this.info.phone, "KMCISWindow", "width=425, height=550, resizable=0, scrollbars=no, status=0, titlebar=0, toolbar=0, left=435, top=250");
    },
    certClose(certData){
      if(certData != null) {
