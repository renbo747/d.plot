    ...
    <div class="inner">
        ...
        <dl>
          ...
          <dd>
            <div class="radio_wrap wide4">
              <input type="radio" name="group00" id="group01" v-model="searchData.gubun" value="depth1"><label for="group01">대분류</label>
              <input type="radio" name="group00" id="group02" v-model="searchData.gubun" value="depth2"><label for="group02">중분류</label>
              <input type="radio" name="group00" id="group03" v-model="searchData.gubun" value="depth3"><label for="group03">소분류</label>
              <input type="radio" name="group00" id="group04" v-model="searchData.gubun" value="depth4"><label for="group04">세분류</label>
            </div>
          </dd>
        </dl>
        <dl>
      ...
      <table cellpadding="0" cellspacing="0" class="data-tb align-r">
        ...
        <tr>
          ...
          <th>대분류
            <button type="button" :value="sortData.name1" class="sort"
                    :class="[{up : sortData.name1 === 'name1_asc'}, {down : sortData.name1 === 'name1_desc'}]"
                    @click="sortToggle(sortData.name1)"></button>
          </th>
          <th>중분류
            <button type="button" :value="sortData.name2" class="sort"
                    :class="[{up : sortData.name2 === 'name2_asc'}, {down : sortData.name2 === 'name2_desc'}]"
                    @click="sortToggle(sortData.name2)"></button>
          </th>
          <th>소분류
            <button type="button" :value="sortData.name3" class="sort"
                    :class="[{up : sortData.name3 === 'name3_asc'}, {down : sortData.name3 === 'name3_desc'}]"
                    @click="sortToggle(sortData.name3)"></button>
          </th>
          <th>세분류
            <button type="button" :value="sortData.name4" class="sort"
                    :class="[{up : sortData.name4 === 'name4_asc'}, {down : sortData.name4 === 'name4_desc'}]"
                    @click="sortToggle(sortData.name4)"></button>
          </th>
          <th>순 주문수량 ①
        ...
        <tr v-for="(row, index) in listData" v-bind:key="index">
          ...
          <td class="center">{{ row.name1 }}</td>
          <td class="center">{{ row.name2 }}</td>
          <td class="center">{{ row.name3 }}</td>
          <td class="center">{{ row.name4 }}</td>
...
export default {
  ...
  methods : {
    ...
    searchList() {
      ...
      this.$http.post('/admin/stats/cate/list', params).then(result =>{
    ...
    // 공통코드 목록 조회
    getCommonCodeList() {
      let cmclassArr = ['MUAPPCHTYPE', 'DADAMEMBERTYPE', 'MEMLVTYPE'];
    ...
    goExcelDownload(){
      ...
      this.$http.post('/admin/stats/cate/list/excel', param, config);
    },
  },
  watch : {
