                    ...
                    <table cellpadding="0" cellspacing="0" class="gray-tb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" v-model="info.catecolor" placeholder="16진수 6자리" style="width: 120px;">
...
export default {
    name: 'admin.operation.shopping.catebanner.regist',
    ...
    methods: {
        setInit() {
            ...
            this.$http.post("/admin/operation/shopping/catebanner/category", param)
            .then(result => {
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                if(confirm("저장하시겠습니까?")){
                    this.$http.post("/admin/operation/shopping/catebanner/save", params)
                    .then(result => {
                        if(result.statusCode === 200){
                            alert("저장되었습니다.");
                            this.onClose(true);
        ...
        checkValidation() {
            ...
            let valid = [
                ...
                {field: 'info.catecolor', type: 'I', name: '카테고리 색상(RGB)', required: true},
            ...
            if(this.info.catecolor.length < 6) {
    ...
    watch: {
        ...
        'info.catecolor': function(value, oldValue) {
            if(this.$util.isNull(value)) return;
            let check = /^[0-9a-fA-F]{0,6}$/gi;
            if(check.test(value)){
                return this.info.catecolor = value;
            }else{
                return this.info.catecolor = oldValue;
            }
        },
    }
}
