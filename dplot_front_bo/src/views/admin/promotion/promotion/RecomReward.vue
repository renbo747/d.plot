                ...
                <table cellpadding="0" cellspacing="0" class="gray-tb">
                    ...
                    <tbody>
                        ...
                        <tr v-show="info.recomtype === 'RCT001' || info.recomtype === 'RCT002'">
                            <th>신규회원 혜택<i class="essential"></i></th>
                            <td>
                                <span>추천인을 입력하고 가입한 신규회원에게 {{info.recomtype === 'RCT001' ? '적립금 ': ''}}{{info.recomtype === 'RCT002' ? 'D포인트 ': ''}}</span>
                        ...
                        <tr v-show="info.recomtype === 'RCT003'">
                            <th>신규회원 혜택<i class="essential"></i></th>
                            <td>
                                <span>추천인을 입력하고 가입한 신규회원에게</span>
                        ...
                        <tr v-show="info.recomtype === 'RCT001' || info.recomtype === 'RCT002'">
                            <th>기존회원 혜택<i class="essential"></i></th>
                            <td>
                                <input type="checkbox" v-model="info.isjoingive" id="group21" true-value="T" false-value="F"/>
                                <span> 신규회원 가입 시 {{info.recomtype === 'RCT001' ? '적립금 ': ''}}{{info.recomtype === 'RCT002' ? 'D포인트 ': ''}}</span>
                                <input type="text" v-model="info.recjoinpoint" class="center" style="width: 60px;" />
                                <span> 포인트 지급</span>
                                <br><input type="checkbox" v-model="info.iscfmgive" id="group22" true-value="T" false-value="F"/>
                                <span> 신규회원 첫 구매확정 시 {{info.recomtype === 'RCT001' ? '적립금 ': ''}}{{info.recomtype === 'RCT002' ? 'D포인트 ': ''}}</span>
                        ...
                        <tr>
                            <th>추천 받는 수 제한<i class="essential"></i></th>
                            <td>
                                <span>1명의 기존회원이 최대 </span>
                                <input type="text" v-model="info.reclimitcnt" class="center" style="width: 60px;"/>
                                <span>명 신규회원에게 추천받기 가능</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
