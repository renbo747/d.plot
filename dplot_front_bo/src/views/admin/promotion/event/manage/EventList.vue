<template>
  <div>
    ...
    <div class="content m-leftmenu">
      ...
      <div class="inner">
        <div class="clearfix">
          <div class="bar-title fl">이벤트 관리</div>
        </div>
        ...
        <div class="caption-group mt10 clearfix">
          ...
          <div class="btn-group fr">
            ...
            <button type="button" class="btn red-line" @click="onChangeUse('T')" v-show="isWrite">미사용</button>
        ...
        <table cellpadding="0" cellspacing="0" class="data-tb align-c">
          ...
          <tr>
            ...
            <th>응모
              <button type="button"
                      :value="sortData.entercount"
                      class="sort"
                      :class="[{up : sortData.entercount === 'entercount_asc'}, {down : sortData.entercount === 'entercount_desc'}]"
                      @click="sortToggle(sortData.entercount)"></button>
            </th>
            <th>시작일자
              <button type="button"
          ...
          <tr v-for="(row, i) in listData" :key="i">
            ...
            <td>{{ row.entercount == null ? '-' : row.entercount }}</td>
            <td>{{ row.evsttime }}</td>
            <td>{{ row.evedtime }}</td>
            <td>{{ row.pubtime }}</td>
            <td>{{ row.regdate }}</td>
        ...
        <div class="bottom-group">
          ...
          <div class="btn-group">
            <button type="button" class="btn blue" @click="goNewPost" v-show="isWrite">이벤트 등록</button>
          </div>
        </div>
      </div>
    </div>
...
<script>
import EventNewPost from "@views.admin/promotion/event/manage/EventNewPost";
import EventDetail from "@views.admin/promotion/event/manage/EventDetail";
...
export default {
  ...
  methods: {
    ...
    onSearchList() {
      ...
      this.$http.post("/admin/promotion/event/search", params)
          .then(result => {
