    ...
    <div class="inner">
      ...
      <div class="caption-group mt10 clearfix">
        ...
        <div class="btn-group fr">
          <button type="button" class=" btn blue-line" @click="onComplete" v-show="isWrite && isAdmin">완료</button>
...
export default {
  ...
  methods: {
    ...
    onComplete() {
      ...
      for (let i in this.listCheckData) {
        let foundData = this.listData.find(e => e.idx === this.listCheckData[i])
        if(foundData.isreply==="완료"){
          alert("답변상태가 대기인것만 완료처리 됩니다.");
          valid = false;
        }
      }
