                ...
                <div class="boxing">
                    <div class="form-area">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" style="width: 100%" placeholder="프로모션명" v-model="info.promoname" maxlength="200" /></dd>
                        </dl>
                        <dl>
                            <dt>설명<i class="essential"></i></dt>
                            <dd><input type="text" style="width: 100%" placeholder="설명" v-model="info.promodesc" maxlength="400"/></dd>
                        </dl>
                    </div>
                </div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="gray-tb">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="radio_wrap">
                                        <div v-for="item in commonCode.promodivtype" :key="item.cmcode">
                                            <input type="radio" name="promodivtypeD" :id="'promodivtypeD_'+item.cmcode" :value="item.cmcode" v-model="info.promodivtype"/>
                                ...
                                <td>
                                    <div class="radio_wrap">
                                        <div v-for="item in commonCode.gifttermtype" :key="item.cmcode">
                                            <input type="radio" name="gifttermtypeD" :id="'gifttermtypeD_'+item.cmcode" :value="item.cmcode" v-model="info.gifttermtype"/>
                                ...
                                <td>
                                    ...
                                    <div class="scroll-y" style="width: 100%; max-height: 350px; margin-bottom: 0;">
                                        <table cellpadding="0" cellspacing="0" class="data-tb align-c">
                                            ...
                                            <tbody v-if="promogoodsList.length > 0">
                            ...
                            <tr v-if="info.promodivtype == $store.getters['ADMIN'].PROMO_DIV_DISCOUNT">
                                ...
                                <td>
                                    <div class="radio_wrap wide dpib">
                                        <input type="radio" name="ispercentD" id="ispercentDF" v-model="info.ispercent" value="F"/>
                                        <label for="ispercentDF">정액</label>
                                        <input type="radio" name="ispercentD" id="ispercentDT" v-model="info.ispercent" value="T"/>
                                        <label for="ispercentDT">정률</label>
                                    </div>
                                    <div v-if="!$util.isNull(info.ispercent)"
                                        :class="{'dpib': info.ispercent == 'F', 'dpn': info.ispercent == 'T'}">
                                        <input type="text" class="right" style="width: 80px;" v-model="info.disprice" maxlength="11"/>
                                        <span class="ml3">원</span>
                                    </div>
                                    <div v-if="!$util.isNull(info.ispercent)"
                                        :class="{'dpib': info.ispercent == 'T', 'dpn': info.ispercent == 'F'}">
                                        <input type="text" class="right" style="width: 80px;" v-model="info.dispercent" maxlength="8"/>
                                        <span class="ml3">%</span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr v-if="(info.promodivtype==$store.getters['ADMIN'].PROMO_DIV_GIFT && info.gifttermtype==$store.getters['ADMIN'].GIFT_TERM_PURCH)
                                ...
                                <td>
                                    <input type="text" class="right" style="width: 50px;" v-model="info.giftgoodscnt" maxlength="5"/>
                            ...
                            <tr v-if="info.promodivtype==$store.getters['ADMIN'].PROMO_DIV_GIFT && !$util.isNull(info.gifttermtype) && info.gifttermtype!=$store.getters['ADMIN'].GIFT_TERM_PURCH">
                                ...
                                <td>
                                    <select v-model="info.isorderprice">
                                        <option value="">기준금액 선택</option>
                                        <option value="T">주문금액</option>
                                        <option value="F">실결제금액</option>
                                    </select>
                                    <span class="ml3">기준</span>
                                    <input type="text" class="right" style="width: 80px;" v-model="info.orderfromprice"/>
                                    ...
                                    <input type="text" class="right" style="width: 80px;" v-model="info.ordertoprice" v-if="info.gifttermtype==$store.getters['ADMIN'].GIFT_TERM_PRICE_RANGE" />
                            ...
                            <tr v-if="info.promodivtype == $store.getters['ADMIN'].PROMO_DIV_GIFT && !$util.isNull(info.gifttermtype)">
                                ...
                                <td>
                                    <div class="caption-group clearfix">
                                        ...
                                        <div class="btn-group fr">
                                            <button type="button" class="btn blue-line" @click="addGift">사은품추가</button>
                                            <button type="button" class="btn red-line" @click="removeGift">삭제</button>
                                        </div>
                                    </div>
                                    <div class="scroll-y" style="width: 100%; max-height: 350px; margin-bottom: 0;">
                                        <table cellpadding="0" cellspacing="0" class="data-tb align-c">
                                            ...
                                            <tbody v-if="promogiftList.length > 0">
                                    ...
                                    <div class="bottom-group" v-if="info.gifttermtype==$store.getters['ADMIN'].GIFT_TERM_FRST_PURCH">
                            ...
                            <tr v-if="info.promodivtype==$store.getters['ADMIN'].PROMO_DIV_GIFT && !$util.isNull(info.gifttermtype) && info.gifttermtype!=$store.getters['ADMIN'].GIFT_TERM_FRST_PURCH">
                                ...
                                <td>
                                    <span>위 사은품 중</span>
                                    <input type="text" class="right ml3" style="width: 50px;" v-model="info.giftselcnt" maxlength="5"/>
                            ...
                            <tr v-if="info.promodivtype == $store.getters['ADMIN'].PROMO_DIV_RESERVE">
                                ...
                                <td>
                                    <div class="radio_wrap wide dpib">
                                        <input type="radio" name="isreserveD" id="isreserveDT" v-model="info.isreserve" value="T"/>
                                        <label for="isreserveDT">적립금</label>
                                        <input type="radio" name="isreserveD" id="isreserveDF" v-model="info.isreserve" value="F"/>
                                        <label for="isreserveDF">D포인트</label>
                                    </div>
                                    <input type="text" class="right ml3" style="width: 80px;" v-model="info.reservepoint" maxlength="11"/>
                            ...
                            <tr v-if="info.promodivtype == $store.getters['ADMIN'].PROMO_DIV_RESERVE && info.isreserve=='F'">
                                ...
                                <td>
                                    <div class="radio_wrap wide dpib">
                                        <input type="radio" name="isepointdupD" id="isepointdupDT" v-model="info.isepointdup" value="T"/>
                                        <label for="isepointdupDT">허용</label>
                                        <input type="radio" name="isepointdupD" id="isepointdupDF" v-model="info.isepointdup" value="F"/>
