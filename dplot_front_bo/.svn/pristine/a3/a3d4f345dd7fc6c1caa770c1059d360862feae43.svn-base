                ...
                <div class="boxing">
                    <div class="form-area">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" v-model="info.cmcode" style="width: 100%" placeholder="공통코드명" /></dd>
                        </dl>
                        <dl>
...
<script>
export default {
    name: 'admin.configuration.manage.coderegist',
    props: ['cmclass'],
    data() {
        return {
            info: {
    ...
    methods: {
        ...
        onClose(isreload) {
            ...
            if(typeof(isreload) === 'boolean'&& isreload) {
                this.$emit('closeCodeRegist', true);
            } else {
                this.$emit('closeCodeRegist');
            }
        },
    }
}
