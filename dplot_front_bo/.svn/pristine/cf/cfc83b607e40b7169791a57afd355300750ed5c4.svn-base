                ...
                <div class="boxing">
                    <div class="form-area">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" v-model="info.subject" style="width: 100%" placeholder="브랜드배너 제목" /></dd>
                        </dl>
                        <dl>
                            <dt>설명</dt>
                            <dd><input type="text" v-model="info.desc" style="width: 100%" placeholder="브랜드배너 설명" /></dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="form-area">
                    <table cellpadding="0" cellspacing="0" class="gray-tb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>대상 브랜드<i class="essential"></i></th>
                                <td>
                                    <input type="search" style="width: 220px;" placeholder="브랜드명을 검색하세요." :maxlength="200"
                                        v-model="info.brandname" @keyup.enter="openSearchBrandPopup"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 620px; height: 150px;" :class="{'no-image': $util.isNull(files['pcimgfile'])}"><!-- 이미지 없는 경우 no-image 클래스 추가 -->
                                            <img style="width: 620px; height: 150px;" :src="imgPreview['pcimgfile']" alt="배너 이미지(pc)" v-if="!$util.isNull(files['pcimgfile'])">
                                        </div>
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 1240*300 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 360px; height: 200px;" :class="{'no-image': $util.isNull(files['mobileimgfile'])}">
                                            <img style="width: 360px; height: 200px;" :src="imgPreview['mobileimgfile']" alt="배너 이미지(모바일)" v-if="!$util.isNull(files['mobileimgfile'])">
                                        </div>
                                        <button type="button" class="btn blue-line mt10" style="width: 100%;"
...
export default {
    name: 'admin.goods.brand.brandbanner.regist',
    props: {
    ...
    methods: {
        setInit() {
            this.info.brandidx = this.brandidx;
            this.info.brandname = this.brandname;
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                if(confirm("저장하시겠습니까?")){
                    this.$http.post("/admin/goods/brand/banner/save", params)
                    .then(result => {
                        if(result.statusCode === 200){
                            alert("저장되었습니다.");
                            this.onClose(true, this.info.brandidx, this.info.brandname);
                        }else{
                            alert("저장에 실패했습니다.");
                        }
                    })
        ...
        checkValidation() {
            ...
            let valid = [
                ...
                {field: 'info.brandidx', type: 'S', name: '대상 브랜드', required: true},
        ...
        openSearchBrandPopup: function() {
            let param = { brandname: this.info.brandname, istrash: 'F' };
        ...
        onClose(isreload, brandidx, brandname) {
            ...
            if (typeof(isreload)==='boolean' && isreload) {
                this.$emit('closeRegist', isreload, brandidx, brandname);
            } else {
