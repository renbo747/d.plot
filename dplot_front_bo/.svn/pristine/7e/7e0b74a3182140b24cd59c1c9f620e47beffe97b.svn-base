        ...
        <div class="inner">
            ...
            <div class="tab-group">
                <scrollactive active-class="active" scrollContainerSelector=".tab-area" bezier-easing-value=".5,0,.35,1"
                    :highlightFirstItem=true :offset="160" :scrollOffset="20" :duration="600" >
                    <ul>
            ...
            <div class="tab-area">
                <div class="boxing" id="tab1">
                    <div class="boxing-title" :class="{closed: !tabObject.tab1.isOpen}">
                        기본 정보<i class="arrcodi" @click="onToggle(tabObject.tab1)"></i>
                    </div>
                        ...
                        <dl>
                            ...
                            <dd>
                                <div class="radio_wrap wide">
                                    <input type="radio" name="isdisplay" id="isdisplayT" value="T" v-model="basicInfo.isdisplay"/>
                                    <label for="isdisplayT">전시</label>
                                    <input type="radio" name="isdisplay" id="isdisplayF" value="F" v-model="basicInfo.isdisplay"/>
                            ...
                            <dd>
                                <div class="radio_wrap">
                                    <div v-for="item in commonCode.goodsselltype" :key="item.cmcode">
                                        <input type="radio" name="goodsselltype" :id="'goodsselltype_'+item.cmcode" :value="item.cmcode" v-model="basicInfo.goodsselltype"/>
                                        ...
                                        <table cellspacing="0" cellpadding="0" class="data-tb align-c mg0" style="width: 100%;">
                                            ...
                                            <tbody v-if="basicInfo.chargemdList.length > 0">
                                                <tr v-for="(item, index) in basicInfo.chargemdList" :key="item.mdcode">
                                                    <td>
                                                        <input type="radio" class="circle" name="mdcode" v-model="basicInfo.mdcode"
                                                            :value="item.mdcode" :id="'mdcode' + index"
                ...
                <div class="boxing" id="tab2">
                    <div class="boxing-title" :class="{closed: !tabObject.tab2.isOpen}">
                        구성상품<i class="arrcodi" @click="onToggle(tabObject.tab2)"></i>
                    </div>
                        ...
                        <div style="margin: 20px;">
                            ...
                            <div class="scroll-y" style="width: 100%; max-height: 500px;">
                                <table cellpadding="0" cellspacing="0" class="data-tb align-c" style="margin-left: 0;">
                                    ...
                                    <thead>
                                        <tr>
                                            <th><input type="checkbox" id="chkgoods" v-model="constInfo.isallchkgoods" @change="checkAllConstGoodsList($event.target.checked)" true-value="T" false-value="F" /></th>
                                            <th>노출순위</th>
                                            <th>대표상품</th>
                                            <th>노출여부</th>
                                            <th>판매구분</th>
                                    ...
                                    <tbody v-if="constInfo.constGoodsList.length > 0">
                                        <tr v-for="(item, index) in constInfo.constGoodsList" :key="index">
                                            <td><input type="checkbox" :id="'chkgoods_'+index" v-model="moveData.targetIdx" :value="index" @change="checkConstGoodsList"/></td>
                                            <td>{{ item.sortnum }}</td>
                                            ...
                                            <td><button type="button" class="btn blue-line" @click="goGoodsDetail(item.goodsno)">수정</button></td>
                                        </tr>
                                    </tbody>
                                    <tbody v-else>
                ...
                <div class="boxing" id="tab3">
                    <div class="boxing-title" :class="{closed: !tabObject.tab3.isOpen}">
                        이미지 정보<i class="arrcodi" @click="onToggle(tabObject.tab3)"></i>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td ref="repreimgtd">
                                            <div class="radio_wrap dpb">
                                                <input type="radio" name="ismaingoodsimage" id="ismaingoodsimageT" @change="setPcrepreImg('T')" v-model="imageInfo.ismaingoodsimage" value="T"/>
                                                <label for="ismaingoodsimageT">대표상품 이미지 사용</label>
                                                <input type="radio" name="ismaingoodsimage" id="ismaingoodsimageF" @change="setPcrepreImg('F')" v-model="imageInfo.ismaingoodsimage" value="F"/>
                                                <label for="ismaingoodsimageF">이미지 직접등록</label>
                                            </div>
                                            <div class="dpb">
                ...
                <div class="boxing" id="tab4">
                    <div class="boxing-title" :class="{closed: !tabObject.tab4.isOpen}">
                        추가정보<i class="arrcodi" @click="onToggle(tabObject.tab4)"></i>
                    </div>
