          ...
          <dl>
            ...
            <dd>
              <select v-model="searchData.skey">
                ...
                <option value="eventsubject">프로모션명</option>
...
import AnnounceNewPost from "./AnnounceNewPost";
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      ...
      this.$http.post("/admin/operation/shopping/promotion/announce/search", params)
          .then(result => {
    ...
    onExcelDownload() {
      ...
      this.$http.post("/admin/operation/shopping/promotion/announce/excel", param, postConfig)
          .then(result => {
