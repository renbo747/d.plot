...
export default {
    name: 'admin.goods.brand.brandbanner.detail',
    props: {
    ...
    mounted() {
        this.$http.post('/admin/common/pageAuth/check', {url : this.$options.name}).then(result => {
            ...
            if(this.isRead){
                ...
                this.$http.post("/admin/goods/brand/banner/detail", param)
                    .then(result =>{
    ...
    methods: {
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                if(params.isdisplay === 'F') { 
                    ...
                    this.$http.post("/admin/goods/brand/banner/check", param)
                    .then(result => {
        ...
        update(params){
            if(confirm(params.msg)){
                this.$http.post("/admin/goods/brand/banner/modify", params)
                .then(result => {
                    if(result.statusCode === 200){
                        alert("저장되었습니다.");
                        this.onClose(true);
