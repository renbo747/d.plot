                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 500*620 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
...
export default {
    name: 'admin.operation.setting.mainpopup.regist',
    ...
    methods: {
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                if(confirm("저장하시겠습니까?")){
                    this.$http.post("/admin/operation/setting/mainpopup/save", params)
                    .then(result => {
