                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 320px; height: 236px;" :class="{'no-image': $util.isNull(files['pcimgfile'])}"><!-- 이미지 없는 경우 no-image 클래스 추가 -->
                                            <img style="width: 320px; height: 236px;" :src="imgPreview['pcimgfile']" alt="대표 이미지(pc)" v-if="!$util.isNull(files['pcimgfile'])">
                                        </div>
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 610*340 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 320px; height: 177px;" :class="{'no-image': $util.isNull(files['mobileimgfile'])}">
                                            <img style="width: 320px; height: 177px;" :src="imgPreview['mobileimgfile']" alt="대표 이미지(모바일)" v-if="!$util.isNull(files['mobileimgfile'])">
                                        </div>
                                        <button type="button" class="btn blue-line mt10" style="width: 100%;"
                                ...
                                <td>
                                    <div class="caption-group clearfix">
                                        ...
                                        <div class="btn-group fr">
                                            <button type="button" class="btn blue-line" v-show="$util.isNull(checkObj.goodsno1)" @click="openGoodsAdditionPopup(1)">상품추가</button>
                                            <button type="button" class="btn red-line" v-show="!$util.isNull(checkObj.goodsno1)" @click="removeGoods(1)">삭제</button>
                                        </div>
                                    </div>
                                    <div class="scroll-y" style="width: 100%; max-height: 350px; margin-bottom: 0;">
                                        <table cellpadding="0" cellspacing="0" class="data-tb align-c">
                                            ...
                                            <tbody v-if="!$util.isNull(checkObj.goodsno1)">
                                                <tr>
                                                    <td>1</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="caption-group clearfix">
                                        ...
                                        <div class="btn-group fr">
                                            <button type="button" class="btn blue-line" v-show="$util.isNull(checkObj.goodsno2)" @click="openGoodsAdditionPopup(2)">상품추가</button>
                                            <button type="button" class="btn red-line" v-show="!$util.isNull(checkObj.goodsno2)" @click="removeGoods(2)">삭제</button>
                                        </div>
                                    </div>
                                    <div class="scroll-y" style="width: 100%; max-height: 350px; margin-bottom: 0;">
                                        <table cellpadding="0" cellspacing="0" class="data-tb align-c">
                                            ...
                                            <tbody v-if="!$util.isNull(checkObj.goodsno2)">
                                                <tr>
                                                    <td>1</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio_wrap">
                                        <input type="radio" name="group04r" id="group41r" v-model="info.isintro" value="T" checked=""><label for="group41r">제공함</label>
                                        <input type="radio" name="group04r" id="group42r" v-model="info.isintro" value="F"><label for="group42r">제공안함</label>
                                    </div>
                                </td>
                            </tr>
                            <tr v-show="info.isintro === 'T'">
                                <th>컨텐츠 소개문구<i class="essential"></i></th>
                                <td>
                                    <input type="text" v-model="info.introdesc" placeholder="소개문구 텍스트" style="width: 100%;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    mounted() {
        this.$http.post('/admin/common/pageAuth/check', {url : this.$options.name}).then(result => {
            ...
            if(this.isRead){
                ...
                this.$http.post("/admin/operation/shopping/shopexthree/detail", param)
                    .then(result =>{
                        this.info = result.data.info;
                        this.files = result.data.files;
                        if(!this.$util.isNull(result.data.goods1)) {
                            this.goods1 = result.data.goods1;
                            this.checkObj.goodsno1 = this.info.goodsno1;
                        }
                        if(!this.$util.isNull(result.data.goods2)) {
                            this.goods2 = result.data.goods2;
                            this.checkObj.goodsno2 = this.info.goodsno2;
                        }
    ...
    methods: {
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                params.goodsno1 = this.checkObj.goodsno1;
                params.goodsno2 = this.checkObj.goodsno2;

                if(this.info.isintro === 'F') {
                    params.introdesc = '';
                }
                ...
                if(params.isdisplay === 'F') {
                    ...
                    this.$http.post("/admin/operation/shopping/shopexthree/check", param)
                    .then(result => {
        ...
        update(params) {
            if(confirm(params.msg)){
                this.$http.post("/admin/operation/shopping/shopexthree/modify", params)
                .then(result => {
                    if(result.statusCode === 200){
                        alert("저장되었습니다.");
                        this.onClose(true);
        ...
        checkValidation() {
            ...
            let valid = [
                ...
                {field: 'info.isintro', type: 'S', name: '소개문구 제공여부', required: true},
            ...
            if(this.info.isintro === 'T') {
                valid.push({field: 'info.introdesc', type: 'I', name: '컨텐츠 소개문구', required: true},);
            }
            ...
            this.$eventBus.$emit('modalShow', CommonAddGoodsPopup, param,
                (result) => {
                    ...
                    if(index === 1) {
                        ...
                        this.checkObj.goodsno1 = goodsinfo.goodsno;
                        ...
                        this.checkObj.goodsno2 = goodsinfo.goodsno;
        ...
        removeGoods(index){
            if(index === 1) {
                this.checkObj.goodsno1 = null;
                this.goods1 = {};
            } else {
                this.checkObj.goodsno2 = null;
                this.goods2 = {};
            }
        },
        onClose(isreload) {
