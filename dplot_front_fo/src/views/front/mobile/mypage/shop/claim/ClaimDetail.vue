    ...
    <div class="container">
          ...
          <div class="free-item__body">
            <template v-for="(gift,index) in giftList">
                    ...
                    >
                      <div class="free-item">
                        <product-thumbnail
                          ...
                          :thumbnail-info="good"
                        />
                        <p class="free-item__name text-gray-700 dp-p-sm mb-0">
                          [선택{{(index2+1)}}] 선택 사은품<br />
                          {{good.giftname}}
                        </p>
                        <p class="free-item__quantity text-gray-700 mb-0 dp-p-sm">
                          {{ good.rcvamt }}개
                        </p>
                      </div>
                    </li>
              ...
              <ul class="ul-dot dp-mt-20" :key="'msg_index'+index" v-if="gift.isadd == 'F'">
                <li class="text-gray-800">반품 시 사은품도 함께 반품해주세요</li>
              </ul>
            </template>
          </div>
        </section>
        ...
        <section class="payment-info__area section-pt-20">
          ...
          <div class="payment-info__body">
            <ul class="list-style-none payment-info__ul" v-if="claimInfo.clmtype != 'CLM003'">
              ...
              <li v-if="!(claimInfo.totsalepromoamt == 0 && claimInfo.totgoodscpnamt == 0 && claimInfo.basketcpnamt == 0 && (claimInfo.totdelivcpnamt + claimInfo.totrtndelivamt) ==0)">
                <div>
                  <ul class="list-style-none">
                    <li>
                      <div class="d-flex justify-content-between">
                        <span class="payment-info__key title font-weight-500">금액</span>
                        <span class="atten-new dp-price01">{{$util.maskComma((claimInfo.basketcpnamt + claimInfo.totsalepromoamt + claimInfo.totgoodscpnamt + claimInfo.totdelivcpnamt  + claimInfo.totrtndelivamt) * -1)}}
                    ...
                    <li v-if="claimInfo.totsalepromoamt > 0">
                      <div class="d-flex justify-content-between">
                        ...
                        <span class="atten-new dp-price02">{{$util.maskComma(claimInfo.totsalepromoamt * -1)}}<span class="price-unit">원</span></span>
                      </div>
                    </li>
                    <li v-if="claimInfo.totgoodscpnamt > 0">
                      <div class="d-flex justify-content-between">
                        <span class="payment-info__key">상품쿠폰</span>
                        <span class="atten-new dp-price02">{{$util.maskComma(claimInfo.totgoodscpnamt * -1)}}<span class="price-unit">원</span></span>
                      </div>
                    </li>
                    <li v-if="claimInfo.basketcpnamt > 0">
                      <div class="d-flex justify-content-between">
                        <span class="payment-info__key">추가쿠폰</span>
                        <span class="atten-new dp-price02">{{$util.maskComma(claimInfo.basketcpnamt * -1)}}<span class="price-unit">원</span></span>
                      </div>
                    </li>
                    <!-- <li>
                      <div class="d-flex justify-content-between">
            ...
            <ul class="list-style-none payment-info__ul li-pt-10" v-if="claimInfo.rtnamt - claimInfo.finadjustamt > 0 || claimInfo.adjustreason != null">
              <!-- <li>
                <div class="d-flex justify-content-between">
      ...
      <template v-if="claimInfo.clmtype != 'CLM003'">
        <section class="total-refund__area section-pt-20">
          ...
          <hr class="dp-hr h1" />          
          <div class="total-refund__body dp-mt-10" v-if="claimInfo.rtnresamt > 0">
            <div class="d-flex justify-content-between">
              <span class="total-refund__key">적립금</span>
              <span class="atten-new dp-price02 font-weight-600">{{$util.maskComma(claimInfo.rtnresamt)}}
                <span class="price-unit">원</span>
              </span>
            </div>
          </div>
          <div class="total-refund__body dp-mt-10" v-if="claimInfo.rtnepoamt > 0">
            <div class="d-flex justify-content-between">
              <span class="total-refund__key">D포인트</span>
              <span class="atten-new dp-price02 font-weight-600">{{$util.maskComma(claimInfo.rtnepoamt)}}
                <span class="price-unit">원</span>
              </span>
            </div>
          </div>
          <div class="total-refund__body dp-mt-10" v-if="claimInfo.rtnempresamt > 0">
            <div class="d-flex justify-content-between">
              <span class="total-refund__key">임직원적립금</span>
              <span class="atten-new dp-price02 font-weight-600">{{$util.maskComma(claimInfo.rtnempresamt)}}
                <span class="price-unit">원</span>
              </span>
            </div>
          </div>
          <div class="total-refund__body dp-mt-10" v-if="claimInfo.rtnpayamt > 0">
            <div class="d-flex justify-content-between">
              ...
              <span class="rtotal-refund__key" v-if="orderInfo.paywaytype != 'PWT001' && orderInfo.paywaytype != 'PWT009'">{{orderInfo.paywaytypename}}</span>
        ...
        <section class="refund-guide__area section-pt-20">
          ...
          <div class="refund-guide__body">
            <ul class="list-style-none refund-guide__ul">
              ...
              <li>
                <div class="refund-guide__text">
                  <p class="text-black">포인트/적립금/임직원적립금</p>
