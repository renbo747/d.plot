...
<style scoped>
  .trend-detail__header__section {border-bottom:1px solid #000; padding: 67px 0 31px 0; margin-bottom: 0; display: flex; flex-direction: column; align-items: flex-start;}
