<template>
    <div class="relay2_event">
        <div class="banner">
			<div class="img_box">
				<img src="http://d2ljev2ny8cy61.cloudfront.net/dplot/platfrom/promotion/raffle2/banner.jpg" alt="매주 화요일에 시작하는 6주간 릴레이 래플 이벤트 - 갖고 싶었던 아이코닉한 상품에 응모하세요">
               <div class="img_star">
                   <img src="http://d2ljev2ny8cy61.cloudfront.net/dplot/platfrom/promotion/raffle2/star_left.png" alt="별 왼쪽">
                   <img src="http://d2ljev2ny8cy61.cloudfront.net/dplot/platfrom/promotion/raffle2/star_right.png" alt="별 오른쪽">
               </div>
           </div>
           <div class="text_box">
        ...
        <div class="section02">
            <div class="wrap_734">
                ...
                <div v-if="rafflecontent[currentraffle].status=='F'">
					...
					<p style="white-space: nowrap; display:flex; font-size:42px; align-items: center; flex-wrap: nowrap; justify-content: center; line-height: 1;">
						<span style="font-family: 'Mont'; font-size:72px; text-stroke: 5px">{{rafflecontent[currentraffle].startdate[0]}}</span >년 
						<span style="font-family: 'Mont'; font-size:72px; text-stroke: 5px; margin-left:20px;">{{rafflecontent[currentraffle].startdate[1]}}</span >월 
						<span style="font-family: 'Mont'; font-size:72px; text-stroke: 5px; margin-left:20px;">{{rafflecontent[currentraffle].startdate[2]}}</span >일 
						<span style="font-family: 'Mont'; font-size:72px; text-stroke: 5px; margin-left:20px;">{{rafflecontent[currentraffle].startdate[3]}}</span >시
					</p>
                ...
                <div class="proceeding">
                    ...
                    <div class="product_item" style="overflow: hidden;">
                        ...
                        <span class="person" v-if="rafflecontent[currentraffle].item.person">{{rafflecontent[currentraffle].item.person}}명</span>
                        <div class="contents">
                    ...
                    >
                        ...
                        >
                            <div :class="rafflecontent[idx].status === 'T' ? 'item clean' : 'item'">
								<div class="img no_act"><img :src="rafflecontent[idx].item.itemimg" :alt="rafflecontent[idx].item.name"></div>
								<div class="act">
									...
									<div class="text_box" v-if="rafflecontent[idx].status !== 'END' && rafflecontent[currentraffle].item.person">
                ...
                <div class="promise_item promise_item02">
                    ...
                    <ul class="num_list">
                        ...
                        <li>
                            ...
                            <span class="text"> 아래 이미지를 클릭하면 이미지가 자동으로 다운로드 됩니다.</span>
                        </li>
                    </ul>
                    <div class="img">
						<a :href="require(`@/assets/pc/img/promotion/grandopen/img-pc.png`)" download="raffle-insta.png">
							<img :src="require(`@/assets/pc/img/promotion/grandopen/img-pc.png`)" alt="다운로드 버튼" />
...
<script>
	...
	import RaffleModalVue from './reffle2_components/RaffleModal.vue';
