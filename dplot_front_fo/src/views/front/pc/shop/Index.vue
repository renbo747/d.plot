...
.shop {
  .shop__vis {padding-bottom: 0 !important;}
  .container {  
    .shop__card {display: none;}
    .shop__newin {
      margin-top: 170px !important;
      .product_list {margin-bottom: 0; }
    }
    .shop__event-banner {margin-top: 70px;}
    .shop__imready {
      margin-top: 100px;
      .vis-swiper {
    ...
    .shop__preorder {
      margin-top: 100px !important;
      .brand-card {margin-bottom: 0;}
      .swiper-container { padding-bottom: 40px; }
    }
  }
  .shop__promotion {margin-top: 100px !important;}
  .shop__md {
    margin-top: 100px !important;
    .card__img {height: auto;}
    &.new-layout.md_pick .card__img img {
      position: relative;
      top: auto;
      left: auto;
      transform: none;
