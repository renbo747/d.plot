    ...
    <div class="order-detail">
            ...
            <div class="order-item" :key="'item_' + index2" >
              <div class="product-item">
                ...
                <div class="item-button">
                  ...
                  <b-button
                    v-if="!(item.isreview === 'T' && button.text === '리뷰작성') && item.ordcnt > 0"
                    :key="index3"
                    class="dp-btn btn-h32"
                    variant="outline-gray-400"
                    squared
      ...
      <template v-if="giftList.length > 0">
        <div class="order-detail__section free-item__section">
          ...
          >
            <div class="dp-mb-20">
              <p class="section__p mb-0 font-weight-500">
                {{ gift.promoname }}
              </p>
            </div>
            <div class="free-item__wrap">
      ...
      <div class="order-detail__section order-payment__section">
        ...
        <div class="section-info">
          <ul class="list-style-none dp-price-info">
            ...
            <li>
              <span class="price-info__key">배송비
                <b-button
            ...
            <li class="price-info__history" v-if="orderInfo.totsalepromoamt + orderInfo.totgoodscpnamt + orderInfo.basketcpnamt + orderInfo.totdelivcpnamt > 0">
              ...
              <ul class="detail-add">
                ...
                <!-- <li>
                  <span>결제수단할인</span><span><span>{{$util.maskComma(orderInfo.basketcpnamt * -1)}}</span>원</span>
                </li> -->
              </ul>
            </li>
          </ul>
            ...
            <div class="section-info">
              <ul class="list-style-none dp-price-info">
                <li v-if="orderInfo.reservetotamt > 0">
                  <span class="price-info__key">적립금</span>
                  <span class="price-info__value">{{$util.maskComma(orderInfo.reservetotamt)}}<span class="price-info__unit noto-sans">원</span></span>
                </li>
                <li v-if="orderInfo.epointtotamt > 0">
                  <span class="price-info__key">D포인트</span>
                  <span class="price-info__value">{{$util.maskComma(orderInfo.epointtotamt)}}<span class="price-info__unit"> P</span></span>
                </li>
                <li v-if="orderInfo.empreservetotamt > 0">
                  <span class="price-info__key">임직원적립금</span>
                  <span class="price-info__value">{{$util.maskComma(orderInfo.empreservetotamt)}}<span class="price-info__unit">원</span></span>
                </li>
          ...
          <div class="section-info">
            <ul class="list-style-none dp-price-info">
              <li>
                ...
                <span class="price-info__value">{{$util.maskComma(paypoint)}}<span class="price-info__unit">원</span></span>
              </li>
            </ul>
          </div>
        </div>
