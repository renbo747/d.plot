...
<style>
    .event .count_down{margin: 10px 0 40px; } 
	.event .count_down p{display:block; font-size:14px; font-weight:600; }
	.event .count_down p.num {font-weight:500; font-size:50px; position:relative; font-family: 'Mont';  line-height: 1.2;}
	...
	.event .count_down > div{display:inline-block; width:22%;  }
	.event .count_down > div:not(:last-child) .num:after{content:':'; position:absolute; right:-5%; top:0;  line-height: 1;}	
</style>