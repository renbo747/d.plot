  ...
  <main class="login">
    <div class="container container-400">
      ...
      <header class="login__header">
        ...
        <!-- <p class="dp-title02 text-gray-700 font-weight-400 mb-0">
      ...
      <section class="login__form">
        ...
        <div class="login__security" v-if="isNeedCaptcha">
          ...
          <div class="security-box">
            <div class="security__img" v-bind:style="{ backgroundImage: 'url(' + captchaImgSrc + ')' ,'background-size': '270px 92px' }">
            ...
            <ul class="security__btn list-style-none">
              <li>
                <b-button
                  class="pc-dp-btn-security dp-btn dp-btn-icon btn-h40"
        ...
        <div class="login__btn">
          ...
          <ul class="btn__signin-login list-style-none">
            ...
            <li>
              <b-button
                class="dp-btn dp-p signin__list"
                variant="gray-800"
                @click="$router.push('/member/id-find');"
              >
                아이디 찾기
              </b-button>
            </li>
            ...
            <li>
              ...
              <b-button
                class="dp-btn dp-p signin__list"
                variant="gray-800"
                @click="$router.push('/member/password-reset');"
              >
                비밀번호 찾기
              </b-button>
            </li>
          ...
          <div class="non-member__button">
            <router-link to="/etc/none-member-order">
              <span class="dp-p">비회원주문조회</span>
            </router-link>
          </div>
          <!-- 비회원 주문조회 버튼 영역-->
        </div>
      ...
      <section class="sns-login">
        ...
        <header class="sns-login__header">
          <p class="sns-title font-weight-400 dp-p">간편 로그인/회원가입</p>
        </header>
        ...
        <ul v-if="browser !== 'Safari'" class="sns-login__list list-style-none">
          <li>
            ...
            >
              ...
              <span class="login__kakao dp-p">카카오 로그인</span>
            </b-button>
          </li>
          <li>
            <b-button
            ...
            >
              ...
              <span class="login__naver dp-p">네이버 로그인</span>
            </b-button>
          </li>
        </ul>
        <!--   sns 로그인     -->
        ...
        >
          <li class="circle-list">
            <a href="#" class="sns-circle-list circle__kakao" @click="kakaoLogin()"></a>
            <span class="circle-list__text">카카오</span>
          </li>
          <li class="circle-list">
            <a href="#" class="sns-circle-list circle__naver" @click="naverLogin()"></a>
...
<script src="@views.mobile/member/Login.js">
</script>
