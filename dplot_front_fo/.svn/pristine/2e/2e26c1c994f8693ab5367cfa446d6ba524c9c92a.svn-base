    ...
    <section class="payment-info__area" v-if="claimInfo.ordtotprice > 0 || claimInfo.addrpaytotprice > 0">
      ...
      <div class="payment-info__body">
        <ul class="list-style-none payment-info__ul" v-if="claimInfo.clmtype != 'CLM003'">
          ...
          <li class="pt-20" v-if="!((claimInfo.totdelivcpnamt + claimInfo.totrtndelivamt) ==0)">
            <div>
              <ul class="list-style-none">
                <li>
                  <div class="d-flex justify-content-between">
                    <span class="payment-info__key title font-weight-500">차감금액</span>
                    <span class="atten-new l-price">{{$util.maskComma((claimInfo.totsalepromoamt + claimInfo.totgoodscpnamt + claimInfo.totdelivcpnamt  + claimInfo.totrtndelivamt) * -1)}}
                      <span class="l-price-unit">원</span>
                    </span>
                  </div>
                </li>
                ...
                <li v-if="(claimInfo.totdelivcpnamt + claimInfo.totrtndelivamt) > 0">
                  <div class="d-flex justify-content-between">
                    ...
                    <span class="atten-new price">{{$util.maskComma((claimInfo.totdelivcpnamt + claimInfo.totrtndelivamt)  * -1)}}<span class="price-unit">원</span></span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <ul class="list-style-none payment-info__ul" v-if="claimInfo.rtnamt > 0">
          <li>
        ...
        <hr class="h1"/>
        <ul class="list-style-none payment-info__ul" v-if="claimInfo.clmtype != 'CLM003'">
          <li v-if="claimInfo.finadjustamt > 0">
            <div class="d-flex justify-content-between">
          ...
          <li v-if="claimInfo.rtnpayamt > 0">
            <div class="d-flex justify-content-between">
              ...
              <span class="refund-info__key" v-else>{{orderInfo.paywaytypename}}</span>
      ...
      <div class="add-payment__header">
        <div class="d-flex justify-content-between">
          ...
          <span class="text-primary dp-caption"
            ><span class="dp-p atten-new font-weight-500 mr-1">{{$util.maskComma(claimInfo.addrpaytotprice)}}</span
            >원</span
          >
        </div>
      </div>
