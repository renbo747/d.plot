<template>
          ...
          >
            ...
            <div class="page-layer__body">
              <span class="dp-badge square h30 promotion__badge">{{eventList.subject}}</span>
              <h2 class="promotion-modal__description-title">
                {{eventList.notice_desc}}
              </h2>

              <p class="promotion-modal__date mb-0">발표일 : {{list.pubtime}}</p>

              <hr class="dp-hr h1" />

              <div class="promotion-modal__text-wrap" v-html="eventList.content">
              </div>
