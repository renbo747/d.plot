    ...
    <section class="cs-inquiry-tab__wrap">
      ...
      <div class="cs-inquiry-tabs">
        <b-tabs>
          <!-- 1:1 문의 탭 -->
          <b-tab title="1:1 문의"
            :active="$route.name.indexOf('inquiry') != -1"
            @click="changeTap('inquiry')">
            <div v-if="$route.name.indexOf('inquiry') != -1"  class="inquiry__area">
              <div class="container">
                <div class="cs-inquiry__header">
                  <div class="cs-inquiry__header__btn d-flex">
                    ...
                    <div>
                      <a style="cursor:pointer" @click="goInquiryReg()">
                        <b-button
                ...
                <div class="cs-inquiry__list dp-panel pb-0" v-if="!$util.isEmpty(inquiryList)">
                    ...
                    >
                      <div class="d-flex inquiry__list__item">
                        <div class="inquiry__list__item__box d-flex">
                          <p
                            class="inquiry__list__item__state mb-0 font-weight-700 mr-10 mb-2"
                            :class="{
                  ...
                  <div class="inquiry-pagination dp-panel pb-0 d-flex">
                    <div class="inquiry-pagination-wrap">
                      <base-pagination :currentPage="currentPage" :totalPage="totalPage" :listTotal="listTotal" :listCnt="listCnt" @changePage="inquiryPage"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="container" v-if="$util.isEmpty(inquiryList) && isEnd">
          ...
          <!-- 상품Q&A 탭 -->
          <b-tab title="상품Q&A" :active="$route.name.indexOf('qna') != -1" @click="changeTap('qna')">
            <div class="cs-product-qna__tab">
              <div class="container" v-if="$route.name.indexOf('qna') != -1">
                ...
                <div class="cs-qna-list-wrap"  v-if="!$util.isEmpty(qnaList)">
                  <ul class="cs-qna-list-ul list-style-none">
                    ...
                    >
                      <div class="cs-qna-list__item__state d-flex mb-20">
                        <p
                          class="cs-qna-list__item__state__text mb-0 font-weight-700 mr-10"
                          :class="{
                  ...
                  <div class="inquiry-pagination dp-panel pb-0 d-flex">
                    <div class="inquiry-pagination-wrap">
                      <base-pagination :currentPage="currentPage" :totalPage="totalPage" :listTotal="listTotal" :listCnt="listCnt" @changePage="qnaPage"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="container" v-if="$util.isEmpty(qnaList) && isEnd">
                <div class="cs-inquiry__list__none">
                  <div class="cs-inquiry__list__circle">
                    <div class="d-flex flex-column align-items-center">
                      <div class="cs-inquiry__list__empty">
