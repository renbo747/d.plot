...
<style>
    .section02 .timer_box{ display: flex;  justify-content: space-between;position: relative;}
    .section02 .timer_box::before{content: '';display: block; width: 100%; height: 2px ; position: absolute; top:15px;left:0; background-blend-mode: overlay; background: linear-gradient(to right, #00f4db, #00f0cd); z-index: 9;}
    .section02 .timer_box .time_con{display: flex; width: 25%;}
    .section02 .timer_box .time_con:not(:last-child)::after{ content: ':'; line-height: 1;margin-left: 1vw; display: block; font-size: 24px;  font-family: 'Mont'; -webkit-text-stroke: 5px #222;position: relative; top:5px}
    .section02 .timer_box .time_con > div{width: 100%; text-align: center;}
    .section02 .timer_box .count_text{font-size: 42px;  line-height: 1;color: #222;font-family: 'Mont';text-stroke: 5px #222;-webkit-text-stroke: 5px #222;margin-bottom: 0;}
    .section02 .timer_box .text{text-align: center; font-family: AttenNew; font-size: 11px; color: #3a3a3a;margin-top: 8px;}
