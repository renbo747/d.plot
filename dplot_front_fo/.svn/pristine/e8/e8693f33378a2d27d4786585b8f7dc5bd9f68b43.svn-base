        ...
        <div class="as__content">
          ...
          <div class="as__content__body">
            <div class="as__content__text__area">
              <p class="mb-0 as__content__text" v-html="product.content"></p>
            </div>
                ...
                <swiper class="swiper" ref="swiper" :options="swiperDetailOption" v-if="files.length > 0">
                  <swiper-slide v-for="(list, index) in files" :key="index">
                    <div class="info__slide__img"  @click="openModal(files,index)">
                      <figure
                        class="info__slide__img__thumbnail cursor" style="height=190px; width=190px; cursor:pointer;"
                      >
            ...
            <!-- <div class="product-photo__slide__area">
              <ul class="dp-slider list-style-none">
                <li
            ...
            <div class="answer__content__area">
              ...
              <div class="answer__content__body">
                <div class="answer__content">
                  ...
                  <p v-if="product.isreply == 'T' && !$util.isNull(product.repuserno)" class="mb-0 manager-name">전담매니저 : {{product.repuserno}}</p>
                </div>
              </div>
            </div>
          </div>
...
<script src="@views.pc/mypage/shop/as/AsDetail.js"/>