  ...
  <main class="dp-signup member-top-padding">
    <div class="container container-400">
      <div>
        ...
        <p
          class="dp-signup__description-executive font-weight-400 dp-title02 mb-0"
        >
      ...
      <form>
        ...
        <div class="email__executive">
          <div class="signup-executive__email">
            <p class="email__label dp-p-sm">이메일 또는 휴대폰번호</p>
        ...
        <b-button class="dp-btn send-btn" variant="outline-gray-400" squared>
          <span class="dp-btn__gray-800 text-gray-800">인증번호 보내기</span>
        </b-button>
        <p class="email-number__label dp-p-sm">
        ...
        <div class="confirm-alert">
          <img
            src="~@/assets/common/icon/icon-check-green-20px.svg"
            alt="check icon"
          />
          <p class="success-text dp-caption text-success mb-0">
            인증번호 확인이 완료되었습니다.
          </p>
        </div>
