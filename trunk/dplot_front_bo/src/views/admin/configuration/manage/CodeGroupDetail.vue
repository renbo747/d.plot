                ...
                <div class="boxing">
                    <div class="form-area">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" v-model="info.cmclass" style="width: 100%" placeholder="공통코드그룹" disabled/></dd>
                        </dl>
                        <dl>
...
<script>
export default {
    name: 'admin.configuration.manage.codegroupdetail',
    props: ['cmclass'],
    components: {
    ...
    methods: {
        ...
        onClose(isreload) {
            ...
            if(typeof(isreload) === 'boolean' && isreload) {
                this.$emit('closeClassDetail', true);
            } else {
                this.$emit('closeClassDetail');
            }
        },
    }
}
