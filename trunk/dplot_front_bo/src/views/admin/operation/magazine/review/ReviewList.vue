        ...
        <div class="inner">
            <div class="boxing search-area">
                <dl>
                    ...
                    <dd>
                        <select v-model="searchData.skey">
                            ...
                            <option value="reguserid">아이디</option>
                            <option value="regusername">이름</option>
                        </select>
                ...
                <dl>
                    ...
                    <dd>
                        <div class="radio_wrap wide3">
                            <input type="radio" name="group03" id="group31" v-model="searchData.isblind" value=""  checked><label for="group31">전체</label>
                            <input type="radio" name="group03" id="group32" v-model="searchData.isblind" value="F" ><label for="group32">공개</label>
                            <input type="radio" name="group03" id="group33" v-model="searchData.isblind" value="T" ><label for="group33">블라인드</label>
                        </div>
                    </dd>
                </dl>
                <dl>
...
export default {
    name: 'admin.operation.magazine.reviewlist',
    components: {
        CommonNavigator,
        CommonDatePicker,
        CommonPageNavigator,
