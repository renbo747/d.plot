...
export default {
    ...
    methods: {
        ...
        searchList(page) {
            ...
            this.$http.post("/admin/operation/magazine/banner/search", param)
            .then(result => {
                let data = result.data;
                this.list = data.list;
        ...
        showChange(show) {
            ...
            if(show === 'F') { 
                ...
                this.$http.post("/admin/operation/magazine/banner/check", params)
                .then(result => {
        ...
        update(params) {
            if(confirm(params.msg)) {
                this.$http.post("/admin/operation/magazine/banner/update", params)
                .then(result => {
                    if (result.statusCode == 200) {
                        alert("저장이 완료되었습니다.");
                        this.searchList();
