                ...
                <div class="form-area">
                    <table cellpadding="0" cellspacing="0" class="gray-tb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>헤더컬러<i class="essential"></i></th>
                                <td>
                                    <div class="radio_wrap wide">
                                        <input type="radio" name="rgrouphead" id="rgrouphead1" v-model="info.iswhite" value="T" checked/><label for="rgrouphead1">흰색</label>
                                        <input type="radio" name="rgrouphead" id="rgrouphead2" v-model="info.iswhite" value="F" /><label for="rgrouphead2">검정색</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 480px; height: 200px;" :class="{'no-image': $util.isNull(files['pcimgfile'])}"><!-- 이미지 없는 경우 no-image 클래스 추가 -->
                                            <img style="width: 480px; height: 200px;" :src="imgPreview['pcimgfile']" alt="배너 이미지(pc)" v-if="!$util.isNull(files['pcimgfile'])">
                                        </div>
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 1920*800 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 360px; height: 737px;" :class="{'no-image': $util.isNull(files['mobileimgfile'])}">
                                            <img style="width: 360px; height: 737px;" :src="imgPreview['mobileimgfile']" alt="배너 이미지(모바일)" v-if="!$util.isNull(files['mobileimgfile'])">
                                        </div>
                                        <button type="button" class="btn blue-line mt10" style="width: 100%;"
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 720*1474 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
export default {
    name: 'admin.operation.magazine.mainbanner.detail',
    props: {
    ...
    mounted() {
        this.$http.post('/admin/common/pageAuth/check', {url : this.$options.name}).then(result => {
            ...
            if(this.isRead){
                ...
                this.$http.post("/admin/operation/magazine/banner/detail", param)
                    .then(result =>{
    ...
    methods: {
        ...
        goSave() {
            if(this.checkValidation()) {
                ...
                if(params.isdisplay === 'F') { 
                    ...
                    this.$http.post("/admin/operation/magazine/banner/check", param)
                    .then(result => {
        ...
        update(params){
            if(confirm(params.msg)){
                this.$http.post("/admin/operation/magazine/banner/modify", params)
                .then(result => {
                    if(result.statusCode === 200){
                        alert("저장되었습니다.");
                        this.onClose(true);
