<template>
    <div class="content m-leftmenu">
        ...
        <ShopExFourRegist v-if="showRegist" v-bind:commonCodeList="commonCode" v-on:closeRegist="closeRegist"></ShopExFourRegist>
        <ShopExFourDetail v-if="showDetail" :commonCodeList="commonCode" :idx="idx" v-on:closeDetail="closeDetail"></ShopExFourDetail>
        <div class="inner">
...
import ShopExFourRegist from './ShopExFourRegist.vue';
import ShopExFourDetail from './ShopExFourDetail.vue';
export default {
    ...
    methods: {
        ...
        searchList(page) {
            ...
            this.$http.post("/admin/operation/shopping/shopexfour/search", param)
            .then(result => {
                let data = result.data;
                this.list = data.list;
        ...
        showChange(show) {
            ...
            this.$http.post("/admin/operation/shopping/shopexfour/check", params)
            .then(result => {
        ...
        update(params) {
            if(confirm(params.msg)) {
                this.$http.post("/admin/operation/shopping/shopexfour/update", params)
                .then(result => {
                    if (result.statusCode == 200) {
                        alert("저장이 완료되었습니다.");
                        this.searchList();
        ...
        fnExcelDownload: function() {
            ...
            this.$http.post('/admin/operation/shopping/shopexfour/excel', this.searchData, config)
            .then(result => {
