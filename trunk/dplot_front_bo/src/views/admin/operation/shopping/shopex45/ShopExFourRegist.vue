                        ...
                        <tbody>
                            ...
                            <tr v-show="info.isbnimg ==='T'">
                                ...
                                <td>
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 288x; height: 324px;" :class="{'no-image': $util.isNull(files['pcimgfile'])}"><!-- 이미지 없는 경우 no-image 클래스 추가 -->
                            ...
                            <tr v-show="info.isbnimg ==='T'">
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 288x; height: 324px;" :class="{'no-image': $util.isNull(files['mobileimgfile'])}">
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 720*810 / 최소: 200*200 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
...
export default {
    ...
    name: 'admin.operation.shopping.shopexfour.regist',
    components: {
        CommonDatePickerFromTo,
        CommonArraySort
    },
    ...
    methods: {
        ...
        checkSave(params) {
            if(confirm(params.msg)){
                this.$http.post("/admin/operation/shopping/shopexfour/save", params)
                .then(result => {
                    if(result.statusCode === 200){
                        alert("저장되었습니다.");
                        this.onClose(true);
        ...
        checkValidation() {
            ...
            /*
            현업 그랜드 오픈 개선요청(김태선)으로 상품 필수입력 제외(2022-08-24, James)
            if(this.goodslist.length === 0) {
                alert("상품을 등록해주세요.");
                return false;
            }*/
