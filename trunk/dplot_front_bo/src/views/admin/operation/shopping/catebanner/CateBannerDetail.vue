                ...
                <div class="boxing">
                    <div class="form-area">
                        ...
                        <dl>
                            ...
                            <dd>
                                <select v-model="info.cateidx" style="width: 450px;">
                                    <option value="">카테고리 선택</option>
                                    <option v-for="(row, c) in this.categorylist" :key="c" :value="row.idx">{{ row.value }}</option>
                                </select>
                            </dd>
                        </dl>
                        <dl>
                            <dt>설명</dt>
                            <dd><input type="text" v-model="info.desc" style="width: 100%" placeholder="카테고리배너 설명" /></dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="form-area">
                    <table cellpadding="0" cellspacing="0" class="gray-tb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>카테고리 색상(RGB)<i class="essential"></i></th>
                                <td>
                                    <input type="text" v-model="checkObj.catecolor" placeholder="16진수 6자리" style="width: 120px;">
                                    <span class="txt-orange ml3"><i class="icon-alert"></i>등록하실 배너와 중첩되지 않는 색상을 등록하세요.</span>                                    
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 207px; height: 207px;" :class="{'no-image': $util.isNull(files['pcimgfile'])}"><!-- 이미지 없는 경우 no-image 클래스 추가 -->
                                            <img style="width: 207px; height: 207px;" :src="imgPreview['pcimgfile']" alt="배너 이미지(pc)" v-if="!$util.isNull(files['pcimgfile'])">
                                        </div>
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 414*414 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="img-with-text" style="width: 202px;">
                                        <div class="img-thumb" style="width: 180px; height: 180px;" :class="{'no-image': $util.isNull(files['mobileimgfile'])}">
                                            <img style="width: 180px; height: 180px;" :src="imgPreview['mobileimgfile']" alt="배너 이미지(모바일)" v-if="!$util.isNull(files['mobileimgfile'])">
                                        </div>
                                        <button type="button" class="btn blue-line mt10" style="width: 100%;"
                                    ...
                                    <div class="img-with-text text">
                                        ...
                                        <p class="txt-orange"><i class="icon-alert"></i>사이즈: 360*360 / 용량: 10MB 이하 / 파일 : JPG, JPEG, PNG</p>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
export default {
    name: 'admin.operation.shopping.catebanner.detail',
    props: {
    ...
    mounted() {
        this.$http.post('/admin/common/pageAuth/check', {url : this.$options.name}).then(result => {
            ...
            if(this.isRead){
                ...
                this.$http.post("/admin/operation/shopping/catebanner/detail", param)
                    .then(result =>{
    ...
    methods: {
        setDateInit() {
            ...
            this.checkObj.catecolor = this.info.catecolor;
        },
        goSave() {
            if(this.checkValidation()) {
                ...
                params.catecolor = this.checkObj.catecolor;
                ...
                if(params.isdisplay === 'F') { 
                    ...
                    this.$http.post("/admin/operation/shopping/catebanner/check", param)
                    .then(result => {
        ...
        update(params){
            if(confirm(params.msg)){
                this.$http.post("/admin/operation/shopping/catebanner/modify", params)
                .then(result => {
                    if(result.statusCode === 200){
                        alert("저장되었습니다.");
                        this.onClose(true);
        ...
        checkValidation() {
            ...
            let valid = [
                ...
                {field: 'checkObj.catecolor', type: 'I', name: '카테고리 색상(RGB)', required: true},
            ...
            if(this.checkObj.catecolor.length < 6) {
                alert("카테고리 색상 6자리를 입력해주세요.");
                return false;
            }
    ...
    watch: {
        ...
        'checkObj.catecolor': function(value, oldValue) {
            if(this.$util.isNull(value)) return;
            let check = /^[0-9a-fA-F]{0,6}$/gi;
            if(check.test(value)){
                return this.checkObj.catecolor = value;
            }else{
                return this.checkObj.catecolor = oldValue;
            }
        },
    }
}
