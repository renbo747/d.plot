<template>
    <div class="content m-leftmenu">
        ...
        <CateBannerRegist v-if="showRegist" v-bind:commonCodeList="commonCode" v-on:closeRegist="closeRegist"></CateBannerRegist>
        <CateBannerDetail v-if="showDetail" :commonCodeList="commonCode" :banidx="idx" v-on:closeDetail="closeDetail"></CateBannerDetail>
                ...
                <dl>
                    ...
                    <dd>
                        <select v-model="searchData.skey">
                            ...
                            <option value="catename">카테고리명</option>
            ...
            <table cellpadding="0" cellspacing="0" class="data-tb align-c">
                ...
                <tbody v-if="this.list.length > 0">
                    <tr v-for="(row, index) in this.list" :key="index">
                        ...
                        <td class="left"><a class="link" @click="goDetail(row.banidx)">{{ row.catename }}</a></td>
                        <td>
                        ...
                        <td>
                            <span class="label circle" :style="'background: #'+row.catecolor"></span>
                            <span>{{ row.catecolor }}</span>
                        </td>
...
import CateBannerRegist from "./CateBannerRegist";
import CateBannerDetail from "./CateBannerDetail";
export default {
    ...
    methods: {
        ...
        searchList(page) {
            ...
            this.$http.post("/admin/operation/shopping/catebanner/search", param)
            .then(result => {
                let data = result.data;
                this.list = data.list;
        ...
        showChange(show) {
            ...
            if(show === 'F') { 
                ...
                this.$http.post("/admin/operation/shopping/catebanner/check", params)
                .then(result => {
        ...
        update(params) {
            if(confirm(params.msg)) {
                this.$http.post("/admin/operation/shopping/catebanner/update", params)
                .then(result => {
                    if (result.statusCode == 200) {
                        alert("저장이 완료되었습니다.");
                        this.searchList();
