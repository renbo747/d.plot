      ...
      <div class="pop-body">
        ...
        <div class="form-area">
          <table cellpadding="0" cellspacing="0" class="gray-tb">
            ...
            <tr>
              <th>종료 프로모션<i class="essential"></i></th>
              <td>
...
export default {
  name: "admin.operation.shopping.promotion.announce.regist",
  ...
  methods: {
    ...
    goSave() {
      ...
      if (confirm("저장 하시겠습니까?")) {
        ...
        this.$http.post("/admin/operation/shopping/promotion/announce/save", params)
            .then(result => {
    ...
    checkValidation() {
      ...
      let endEvent = this.endEventList.find(obj => obj.eventidx === this.boardInfo.eventidx);
    ...
    // 종료 이벤트 조회
    setEndEventList() {
      this.$http.post("/admin/operation/shopping/promotion/announce/search/event", {})
          .then(result => {
            if (result.statusCode === 200) {
