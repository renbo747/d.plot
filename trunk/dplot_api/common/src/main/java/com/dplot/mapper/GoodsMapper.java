...
public interface GoodsMapper {
	 ...
	 * @return
	 */
	List<SOMap> selectCommonEpGoodsList(SOMap param);
	 ...
	 * @return
	 */
	List<SOMap> selectNaverEpGoodsList(SOMap param);
	...
	/**
	 * 추천 정보 조회 - function 을 view테이블로 튜닝
	 * @param param
	 * @return
	 */
	SOMap selectRecomListView(SOMap param);
}