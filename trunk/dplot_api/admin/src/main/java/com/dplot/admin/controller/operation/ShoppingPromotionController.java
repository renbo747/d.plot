...
public class ShoppingPromotionController extends ExcelDownController {
    ...
    public Response lottery(@RequestBody SOMap params) throws Exception {
        return shoppingPromotionService.updatePromotionLottery(params);
    }
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lotteryinit", method = RequestMethod.POST)
	public Response lotteryinit(@RequestBody SOMap params) throws Exception {
		return shoppingPromotionService.updatePromotionLotteryinit(params);
	}
	 ...
	 */
	 ...
	 public Response raffleWinList(@RequestBody SOMap param) throws Exception {
	 	return shoppingPromotionService.raffleWinList(param);
	 }
		 ...
		 *
		 */
		@RequestMapping(value = "/raffleentrylist", method = RequestMethod.POST)
		public Response raffleEntryList(@RequestBody SOMap param) throws Exception {
			return shoppingPromotionService.raffleEntryList(param);
		}
}
