...
public class AdminCouponController extends ExcelDownController{
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/getDownUseCount", method = RequestMethod.POST)
    public Response getDownUseCount(@RequestBody SOMap params) throws Exception {
        return new Response(adminCouponService.getDownUseCount(params));
    }
}