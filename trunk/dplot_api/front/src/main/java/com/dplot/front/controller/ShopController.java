...
public class ShopController {
	...
	public Response selectShopMain1(@RequestBody SOMap param) throws Exception {
		return new Response(shopService.selectShopMain1(param));
	}
	...
	public Response selectShopMain2(@RequestBody SOMap param) throws Exception {
		return new Response(shopService.selectShopMain2(param));
	}
}
