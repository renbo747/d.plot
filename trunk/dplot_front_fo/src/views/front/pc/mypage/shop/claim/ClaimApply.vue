  ...
  <main class="dp-mypage-cancel-apply-pc">
                ...
                <ul class="list-style-none">
                  ...
                  <li v-if="calinfo.totsalepromoamt > 0">
                    <div class="d-flex justify-content-between">
                      ...
                      <span class="atten-new price">{{$util.maskComma(calinfo.totsalepromoamt * -1)}}<span class="price-unit">원</span></span>
                    </div>
                  </li>
                  <li v-if="calinfo.totgoodscpnamt > 0">
                    <div class="d-flex justify-content-between">
                      <span class="payment-info__key">상품쿠폰</span>
                      <span class="atten-new price">{{$util.maskComma(calinfo.totgoodscpnamt * -1)}}<span class="price-unit">원</span></span>
                    </div>
                  </li>
                  <!-- <li>
                    <div class="d-flex justify-content-between">
                  ...
                  <li v-if="calinfo.basketcpnamt > 0">
                    <div class="d-flex justify-content-between">
                      ...
                      <span class="atten-new price">{{$util.maskComma(calinfo.basketcpnamt * -1)}}<span class="price-unit">원</span></span>
                    </div>
                  </li>
                  <li v-if="calinfo.totdelivcpnamt > 0">
                    <div class="d-flex justify-content-between">
                      <span class="payment-info__key">배송비쿠폰</span>
                      <span class="atten-new price">{{$util.maskComma(calinfo.totdelivcpnamt * -1)}}<span class="price-unit">원</span></span>
                    </div>
                  </li>
                  <li v-if="calinfo.totrtndelivamt > 0">
                    <div class="d-flex justify-content-between">
                      <span class="payment-info__key">배송비차감</span>
                      <span class="atten-new price">{{$util.maskComma(calinfo.totrtndelivamt  * -1)}}<span class="price-unit">원</span></span>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <ul class="list-style-none payment-info__ul" v-if="calinfo.rtnamt > 0">
            ...
            <li v-if="calinfo.rtnresamt > 0">
              <div class="d-flex justify-content-between">
                ...
                <span class="atten-new price">{{$util.maskComma(calinfo.rtnresamt)}}<span class="price-unit">원</span></span>
              </div>
            </li>
            <li v-if="calinfo.rtnepoamt > 0">
              <div class="d-flex justify-content-between">
                <span class="refund-info__key">D포인트</span>
                <span class="atten-new price">{{$util.maskComma(calinfo.rtnepoamt)}}<span class="price-unit"> P</span></span>
              </div>
            </li>
            <li v-if="calinfo.rtnempresamt > 0">
              <div class="d-flex justify-content-between" v-if="calinfo.rtnempresamt > 0">
                <span class="refund-info__key">임직원적립금</span>
                <span class="atten-new price">{{$util.maskComma(calinfo.rtnempresamt)}}<span class="price-unit">원</span></span>
              </div>
            </li>
    ...
    <template v-if="giftList.length > 0">
      <section class="free-item__area">
        <div class="free-item__header__area">
          <p class="mb-0 free-item__header title">사은품</p>
        </div>
        <div class="free-item__description__area" v-for="(gift,index) in giftList" :key="index">
          <p class="pb-20 free-item__description">
            {{gift.promoname}}(최대 {{gift.giftselcnt}}개 선택)
          </p>
          <ul class="row list-style-none" style="margin-bottom: 20px;" v-for="(goods,index2) in gift.detail" :key="index2">
            <li class="col-6 col-xl-4" v-for="(good,index3) in goods" :key="index3">
              <div class="free-item d-flex">
                ...
                <div class="d-flex flex-column justify-content-center ml-3">
                  ...
                  <p class="mb-0 mt-1">{{good.rcvamt}}개</p>
                </div>
              </div>
            </li>
          </ul>
...
<script src="@views.mobile/mypage/shop/claim/ClaimApply.js">
</script>
