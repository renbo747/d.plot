<template>
  <main class="dp-member-withdraw-pc">
    <div class="container">
      <section class="member-withdraw__title__area">
        <div class="member-withdraw__title">회원탈퇴</div>
      </section>
      <section class="member-withdraw__txt">
...
<script src="@views.mobile/mypage/activity/memberInfo/MemberWithdraw.js">
</script>
