<template>
  <main class="dp-mypage-return">
    <div class="container">
      <section class="mypage-return__header">
      ...
      <section class="mypage-return__body">
              ...
              <div class="apply__product-info__area">
                ...
                <ul
                  ...
                  <li
                    ...
                    <div v-if="item.excitem != null" style="color:#999;">
                      └
                    </div>
        ...
        <!-- 내역이 없을 떄-->
        <div v-if="isEnd && claimList.length <= 0" class="d-flex flex-column align-items-center as__empty-apply__area">
