<template>
  <main class="dp-member-modify">
    <div class="container">
          ...
          <div class="info-modify__input-area">
            ...
            <div class="form-group" v-if="memberInfo.joinchtype === 'UCT001'">
              <base-input
                ...
                :class="{ 'is-error': pwFail && !$util.isNull(memberInfo.userpw)}"
                :invalid="pwFail && !$util.isNull(memberInfo.userpw)"
              >
                <span v-if="pwFail && !$util.isNull(memberInfo.userpw)"
            ...
            <div class="form-group">
              <base-input
                ...
                :class="{ 'is-error': emailFail || emailFail2 || emailFail3 ||emailFail4 }"
                :invalid="emailFail || emailFail2 || emailFail3 || emailFail4"
              >
                ...
                <span v-if="emailFail4"> 이메일주소를 입력해주세요. </span>
              </base-input>
            </div>
      ...
      <!-- <hr class="dp-hr justify-margin" /> -->
      <!-- <section
        class="lifetime-member__area"
        v-if="
          memberInfo.dadamembertype === 'DMT001' ||
          memberInfo.dadamembertype === 'DMT002'
        "
      >
        <div class="lifetime-member__header d-flex justify-content-between">
          <div class="lifetime-member__title dp-p">[선택]평생회원으로 가입</div>
          <div
      ...
      <section>
        <div class="lifetime-member__footer">
...
<script src="./InfoModify.js"></script>
