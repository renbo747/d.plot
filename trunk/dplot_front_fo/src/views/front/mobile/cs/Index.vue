    ...
    <div class="container">
          ...
          <ul class="service__ul list-style-none">
            <li>
              ...
              >
                ...
                <div>
                  <p class="modal-text01 dp-mb-10 font-weight-500">멤버십</p>
                  <p class="modal-text02 mb-0">
                    D.PLOT 멤버십은 누구나 가입이 가능하지만 누구나 다 같은
                    혜택은 아닐 것 입니다. 멤버십 혜택을 확인 해 보세요.
                  </p>
                </div>
              </b-modal>
      ...
      <section class="dp-panel">
        <header class="dp-panel__header">
          ...
          <router-link class="cs-link" :to="{name:'cs-notice',  params: { init: true}}">
            <span>더보기</span>
            <i class="dp-icon icon-arrow-right gray"></i>
          </router-link>
        </header>
        ...
        <ul class="cs-notice__ul list-style-none">
          <li v-for="(list, index) in noticeData" :key="index">
            <a class="notice-link" @click="goDetail(list.idx)">
